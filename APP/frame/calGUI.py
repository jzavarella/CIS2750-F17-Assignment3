...
class App(tk.Tk):
    ...
    def __init__(self, title):
        ...
        self.calDriver = driver.CalendarDriver("bin/libcparse.so")
        print(calDriver.validateCalendar("cals/valid_one_alarm.ics"))

        for _ in range(80):
            self.insertCalendar(2, 3, "summar") # Populate with test data TODO: Remove this
    ...
    def insertCalendar(self, props, alarms, summary):
        n = len(self.components.get_children("")) + 1 # Get number of elements in list and add 1
        self.components.insert("" , "end", values=(n, props, alarms, summary)) # Put the component in the list
